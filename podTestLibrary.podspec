...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/wangweihong24/podTestLibrary'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'wangweihong24' => 'wangweihong24@jd.com' }
  s.source           = { :git => 'https://github.com/wangweihong24/podTestLibrary.git', :tag => s.version.to_s }
